...
if(!isset($_SESSION['user'])) {
  ...
  $utilisateur->redirect('/admin/index.php');
}

$admin = $utilisateur->find($_SESSION['user']['email']);
        ...
        <ul class="nav navbar-nav">
         ...
         <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"> <?= $admin['nom'] ." | " . $admin['role'];?> </span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="employe.php">
            <i class="fa fa-user"></i> <span>Employées</span>
        ...
        <li>
          <a href="agences.php">
            <i class="fa fa-building"></i> <span>Agences</span>
